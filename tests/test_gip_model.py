...
class DynamicsTests(unittest.TestCase):
    ...
    def test_deactivation_reactivation_and_supported_persistence(self):
    ...
    def test_fresh_gates_after_activity_moves(self):
    ...
    def test_nodewise_propagation_uses_recipient_bounds(self):
